...
const Button = ({
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-cyan-600 to-cyan-500 text-white hover:scale-105 shadow-lg hover:shadow-xl',
    secondary: 'bg-white text-cyan-600 border-2 border-cyan-600 hover:bg-cyan-50',
    outline: 'bg-transparent border-2 border-gray-300 text-gray-700 hover:border-cyan-600 hover:text-cyan-600',
